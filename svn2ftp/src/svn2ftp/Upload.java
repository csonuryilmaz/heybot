...
import static svn2ftp.Svn2Ftp.tryExecute;
...
public class Upload
{
	...
	if (sftpHost != null && sftpUser != null && sftpPass != null && sftpTargetDir != null)
	{
		...
		sftpSourceDir = Svn2Ftp.tryExecute("pwd");
	    }
	    String svnCommand = Svn2Ftp.tryExecute("which svn");
	    // ---- some log
    ...
    {
	String output = Svn2Ftp.tryExecute(svnCommand + " info " + sftpSourceDir);
