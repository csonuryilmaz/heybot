...
```bash
wget https://github.com/csonuryilmaz/heybot/releases/download/1.29.2.7/heybot-1.29.2.7.tar.gz
tar -zxvf heybot-1.29.2.7.tar.gz
cd heybot-1.29.2.7
...
```bash
wget https://github.com/csonuryilmaz/heybot/releases/download/1.29.2.7/heybot-1.29.2.7.tar.gz -P ~/Downloads
tar -zxvf ~/Downloads/heybot-1.29.2.7.tar.gz
chmod a+x heybot-1.29.2.7/install.sh
heybot-1.29.2.7/install.sh
```
