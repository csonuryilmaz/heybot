...
```bash
wget https://github.com/csonuryilmaz/heybot/releases/download/2.8.0.2/heybot-2.8.0.2.tar.gz
tar -zxvf heybot-2.8.0.2.tar.gz
cd heybot-2.8.0.2
...
```bash
wget https://github.com/csonuryilmaz/heybot/releases/download/2.8.0.2/heybot-2.8.0.2.tar.gz -P ~/Downloads
tar -zxvf ~/Downloads/heybot-2.8.0.2.tar.gz
chmod a+x heybot-2.8.0.2/install.sh
heybot-2.8.0.2/install.sh
```
