...
```bash
wget https://github.com/csonuryilmaz/heybot/releases/download/2.8.0.1/heybot-2.8.0.1.tar.gz
tar -zxvf heybot-2.8.0.1.tar.gz
cd heybot-2.8.0.1
...
```bash
wget https://github.com/csonuryilmaz/heybot/releases/download/2.8.0.1/heybot-2.8.0.1.tar.gz -P ~/Downloads
tar -zxvf ~/Downloads/heybot-2.8.0.1.tar.gz
chmod a+x heybot-2.8.0.1/install.sh
heybot-2.8.0.1/install.sh
```
